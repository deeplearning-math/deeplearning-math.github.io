...
parser.add_argument('--shuffle-prob', type=float, default=0.0)
parser.add_argument('--random-prob', type=float, default=0.0)
parser.add_argument('--Gaussian-prob', type=float, default=0.0)
...
parser.add_argument('--arch', default='wide-resnet', choices=['wide-resnet', 'mlp', 'CNN'])
