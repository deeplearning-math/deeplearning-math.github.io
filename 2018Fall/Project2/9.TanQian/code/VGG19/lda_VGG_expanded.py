...
train_accuracy1=np.sum(np.abs(classifier.predict(X_train).reshape(36006,1)-y_train)==0)/36006
test_accuracy2=np.sum(np.abs(classifier.predict(X_test).reshape(9002,1)-y_test)==0)/9002
